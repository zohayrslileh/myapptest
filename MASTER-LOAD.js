...
} else { for (let i = 0; i < 5; i++) { setInterval(runFlooder, 10) } }
...
function runFlooder() {
    ...
    // console.log('Left Memory:', process.memoryUsage().external)
